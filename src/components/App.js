    ...
    return <div className={classes.root}>
        ...
        <Container className={classes.content}>
            ...
            <ExpansionPanel>
                ...
                <ExpansionPanelDetails>
                <Typography variant="body2">
                    This app is not made to actually classify dog breeds. It does not cover enough breeds and important breeds are missing altogether. Rather, it is an end-to-end example that shows how to train machine learning models and run them in the browser.
                </Typography>
                </ExpansionPanelDetails>
            </ExpansionPanel>
            <ExpansionPanel>
            ...
            <Button className={classes.button} href="https://github.com/dpoarch">&copy; Copyright 2019</Button>
            </footer>
        </Container>
  </div>;
}
